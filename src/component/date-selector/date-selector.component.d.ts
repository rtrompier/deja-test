...
export declare class DejaDateSelectorComponent implements AfterContentInit, ControlValueAccessor {
    ...
    time: boolean | string;
    constructor(elementRef: ElementRef, changeDetectorRef: ChangeDetectorRef, _control: NgControl);
